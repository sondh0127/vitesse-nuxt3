...
import type { ListItemProps } from '@/components/a/list-item/props'
import AListItem from '@/components/a/list-item/index.vue'
import { useGroupModel } from '@/composables/anu/useGroupModel'
