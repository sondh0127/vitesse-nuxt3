...
import type { ConfigurableValue } from '@/composables/anu/useConfigurable'
import { color as colorProp, configurable as configurableProp, disabled as disabledProp } from '@/composables/anu/useProps'
